...
human_get_python = HumanMessagePromptTemplate(
    ...
    1. Determine what matplotlib plot would be most appropriate for this request. The plot has to be human readable.
    ...
    4. Write the python code. Save your plot in `saved_figure` variable using ```saved_figure = plt.gcf()```. Also save the final dataframe in `saved_dataframe` variable.
""",
...
gpt4_seq1_pyplot = SequentialChain(
